...
public class WeatherInfo {
	...
	public String toString() {
		return "WeatherInfo [city=" + city + ", city_en=" + city_en
				...
				+ ", city_id=" + cityid + ", fchh=" + fchh + ", temp1="
				+ temp1 + ", temp2=" + temp2 + ", temp3=" + temp3 + ", temp4="
				+ temp4 + ", temp5=" + temp5 + ", temp6=" + temp6 + ", tempF1="
				...
				+ ", index_uv=" + index_uv + ", index48_uv=" + index48_uv
				+ ", index_xc=" + index_xc + ", index_tr=" + index_tr
				+ ", index_co=" + index_co + ", st1=" + st1 + ", st2=" + st2
				+ ", st3=" + st3 + ", st4=" + st4 + ", st5=" + st5 + ", st6="
				+ st6 + ", index_cl=" + index_cl + ", index_ls=" + index_ls
				+ ", index_ag=" + index_ag + "]";
	}
