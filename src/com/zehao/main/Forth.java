...
import com.zehao.main.Third.MyPagerAdapter;
...
public class Forth extends TabBarFragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentLayout(R.layout.forth);

		setRadio(4);

		longToastHandler("This is the Forth,Forth,Forth Activity!");
